...
export async function createCommunity(id: string,
    ...
    try {
        ...
        console.log(`error in creating community ${error.message}`)
    }
}
...
export async function addMemberToCommunity({
    ...
    try {
        ...
        throw new Error(`Error adding members to community ${error.message}`)
    }
}
...
export async function removeUserFromCommunity({
    ...
    try {
        ...
        throw new Error(`Error in updating community ${error.message}`)
    }
}
